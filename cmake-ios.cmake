...
function(add_ios_entitlements target)
  ...
  file(READ "${ios_module_dir}/Entitlements.plist" template)
...
function(add_ios_iconset target)
  set(one_value_keywords
    DESTINATION
  )
...
function(add_ios_bundle_info target)
  set(one_value_keywords
    DESTINATION
    NAME
    VERSION
  ...
  file(READ "${ios_module_dir}/Info.plist" template)
...
function(add_ios_bundle target)
  set(one_value_keywords
    DESTINATION
    INFO
    ICON
  ...
  set(commands
    COMMAND ${CMAKE_COMMAND} -E copy_if_different "${ARGV_INFO}" "${ARGV_DESTINATION}/Info.plist"
  )
  ...
  while(TRUE)
    ...
    list(APPEND commands
      COMMAND ${CMAKE_COMMAND} -E ${command} "${from}" "${ARGV_DESTINATION}/${to}"
    )
  endwhile()

  list(APPEND commands
    COMMAND ${CMAKE_COMMAND} -E copy_if_different "${ARGV_EXECUTABLE}" "${ARGV_DESTINATION}/${ARGV_EXECUTABLE_NAME}"
  )
